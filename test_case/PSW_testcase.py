...
defined as Equation BLAH in the README file, to the orbit of Jupiter. 
'''
...
radial_distance = 228e6 #Kilometers, Range: Critical Radius to 766.44e6 km

#Location where you want to save all output files.
output_filepath_RK4 ='/d/cha1/kconder/PHYS4840_labs/final_project/test_case/RK4_solarwind_data_MARS.txt'	#RK4 solar wind data location
output_filepath_PSW_graph = '/d/cha1/kconder/PHYS4840_labs/final_project/test_case/parker_solar_wind_plot_MARS.png'	#Parker Solar Wind Results Plot
output_filepath_p_spiral = '/d/cha1/kconder/PHYS4840_labs/final_project/test_case/parker_spiral_plot_MARS.png'
